...
--verdadeira, pois a segund;a condicao nao será checada nesse caso.
...
/* ESSE É O COMANDO CORRETO, QUE É UTILIZADO PARA TRAZER NULOS*/
...
INSERT INTO CLIENTES(NOME,CPF,EMAIL,TELEFONE,ENDERECO,SEXO) VALUES('JOAO',00012312312,'JOAO@HOTMAIL.COM',998768888,'AV JOSE DOS PINHAIS 12','M');
...
INSERT INTO CLIENTES VALUES('CARLA',45638854,'C.LOPES@UOL.COM','4575-0048',
'RUA COPPER LEAF - WILLIAMSBURG - KITCHENER','F');

DELETE FROM CLIENTES
WHERE NOME = 'CARLA'
AND EMAIL = 'C.LOPES@UOL.COM';
...
INSERT INTO TELEFONE VALUES(NULL,'COM','44522579',21);

/*SELECT JONATHAN*/

SELECT C.NOME, C.CPF, T.TIPO, T.NUMERO, E.CIDADE, E.ESTADO
FROM CLIENTE C
INNER JOIN TELEFONE T
ON C.IDCLIENTE = T.ID_CLIENTE
INNER JOIN ENDERECO E
...
CREATE PROCEDURE CONSULTA_CURSO(P_NOME VARCHAR(30), P_HORAS INT(30),
						   P_PRECO  FLOAT(10,2))
						   	
BEGIN

		SELECT NULL AS 'ID' , P_NOME, P_HORAS, P_PRECO FROM CURSOS;
...
MEU: (JONATHAN TENTATIVA)
SELECT MIN(MARCO) AS 'PIOR VENDEDOR', NOME
FROM VENDEDORES;
...
SELECT NOME, MARCO AS 'PIOR VENDEDOR' FROM VENDEDORES
